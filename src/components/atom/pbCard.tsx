...
const PbCard = ({weight,exerciseTitle,date,color}:PbCardProps) => {
  ...
  return (
    ...
    <div className={`h-32 m-2 rounded rounded-lg border border-specialPink bg-${color}`} >
        <h1 className='flex justify-center  text-center text-textColor uppercase font-semibold flex flex-col m-2'>{exerciseTitle}
